...
const data: Array<ServiceType> = [
    {
        ...
        image: "https://cdn-icons-png.flaticon.com/512/18596/18596027.png",
    },
    {
        title: "Expertise",
        description: "With extensive design and development expertise, Diffco ensures the best results with the right approach. You need a company you can trust and rely on—choosing Diffco unlocks trusted expertise for every backend development project.",
        image: "https://cdn-icons-png.flaticon.com/512/1055/1055687.png",

    },
    {
        title: "Scalability",
        description: "Our backend systems are designed to scale and grow alongside your business. As your company evolves, your backend solutions will change with it and enable your business to operate at its best.",
        image: "https://cdn-icons-png.flaticon.com/512/4149/4149678.png",
    },
    {
        title: "Out-of-the-box thinking",
        description: "We don’t just create—we innovate. Our team uses creativity to develop standout features. With immense knowledge and unique ideas, we deliver custom, cutting-edge solutions that help our clients achieve their goals.",
        image: "https://cdn-icons-png.flaticon.com/512/9617/9617744.png",
...
const BackendDetailPage = () => {
    const navigate = useNavigate()
    return (
        <div className="bg-primary text-primary-foreground min-h-screen">
            <Header />
            <div>
                <div className="flex flex-col items-center py-20 h-screen md:h-auto max-w-7xl mx-auto px-4">
                    <div className="relative overflow-auto h-full md:h-[30rem] px-4 sm:min-w-[40] space-y-10">
                        ...
                        <p>We build secure, scalable, and high-performance backend solutions, leveraging advanced technology to meet your unique requirements.</p>
