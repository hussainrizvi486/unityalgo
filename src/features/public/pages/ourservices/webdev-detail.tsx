...
const data: Array<ServiceType> = [
  ...
  },
  {
    ...
    description: "Both UI and UX play a key role in our development process.UX ensures functionality and intuitive user journeys",
    image: "https://cdn-icons-png.flaticon.com/512/18570/18570961.png",

  },
  {
    title: "Seamless E-commerce & Landing Page Development",
    description: "We create high-performance eCommerce sites and landing pages, prioritizing usability, aesthetics, and seamless user experience with intuitive navigation, responsive design, and interactive elements.",
    image: "https://cdn-icons-png.flaticon.com/512/7407/7407914.png",
  },
  {
    title: "Front-end modernization",
    description: "Front-end modernization improves performance, enhances usability, and ensures compatibility with the latest technologies, providing a fresh and engaging experience for your users.",
...
export default WebDevDetailPage
